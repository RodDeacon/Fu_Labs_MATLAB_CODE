...
function setupObjects(gui)
    ...
    gui.objects.piezos(1) = mcaDAQ(instr.axesGroups{1, 1}{1, 2}.config);
    gui.objects.piezos(2) = mcaDAQ(instr.axesGroups{1, 1}{1, 3}.config);
    gui.objects.piezos(3) = mcaDAQ(instr.axesGroups{1, 1}{1, 4}.config);
