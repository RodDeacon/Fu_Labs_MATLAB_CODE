# Welcome to the Functions26 package!
...
To simply install:
    ...
    pip install dist/functions26-0.1.4.10.tar.gz
...
When you make changes here, make sure to run the following commands to update the package:
    ...
    python -m pip install dist/functions26-0.1.4.10.tar.gz
    python -m setup.py sdist bdist_wheel & python -m pip install dist/functions26-0.1.4.10.tar.gz 
_________________________________
